      ...
      <div className='flex flex-col gap-[35px]'>
        <div className='flex justify-between items-center'>
          <div className='flex justify-between items-center gap-[14px]'>
            ...
            <span className='w-full bg-[#C6C6C6] py-1 px-[6px] text-sm cursor-pointer hover:bg-gray-600 rounded-[4px] hover:text-white transition-all duration-200s'>{name}</span>
          </div>
